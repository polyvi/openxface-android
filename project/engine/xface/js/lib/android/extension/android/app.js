 ...
 * @since 3.1
 */
app.queryInstalledNativeApp = function(type, successCallback, errorCallback){
    argscheck.checkArgs('sfF', 'App.queryInstalledNativeApp', arguments);
    exec(successCallback, errorCallback, null, "App", "queryInstalledNativeApp", [type]);
};
 ...
 * @since 3.1
 */
app.uninstallNativeApp = function(packageName, successCallback, errorCallback){
    argscheck.checkArgs('sFF', 'App.uninstallNativeApp', arguments);
    exec(successCallback, errorCallback, null, "App", "uninstallNativeApp", [packageName]);
};
